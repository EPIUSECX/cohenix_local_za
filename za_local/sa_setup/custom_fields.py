...
def _get_irp5_custom_field_fixtures():
	...
	return [
		...
		{
			"doctype": "Custom Field",
			"name": "Salary Component-za_payroll_treatment",
			"dt": "Salary Component",
			"module": "SA Payroll",
			...
			"description": "South African payroll treatment used for PAYE, UIF, SDL, COIDA, EMP201 and IRP5 classification.",
		},
		{
			"doctype": "Custom Field",
			"name": "Salary Component-za_paye_inclusion_percentage",
			"dt": "Salary Component",
			"module": "SA Payroll",
			...
			"description": "Percentage of this component included in PAYE remuneration. Fixed travel allowance defaults to 80%, or 20% when the statutory reduced inclusion rule applies.",
		},
		{
			"doctype": "Custom Field",
			"name": "Salary Component-za_statutory_bases_section",
			"dt": "Salary Component",
			"module": "SA Payroll",
		...
		{
			"doctype": "Custom Field",
			"name": "Salary Component-za_uif_applicable",
			"dt": "Salary Component",
			"module": "SA Payroll",
		...
		{
			"doctype": "Custom Field",
			"name": "Salary Component-za_sdl_applicable",
			"dt": "Salary Component",
			"module": "SA Payroll",
		...
		{
			"doctype": "Custom Field",
			"name": "Salary Component-za_coida_applicable",
			"dt": "Salary Component",
			"module": "SA Payroll",
		...
		{
			"doctype": "Custom Field",
			"name": "Salary Component-za_is_reimbursement",
			"dt": "Salary Component",
			"module": "SA Payroll",
			"label": "Reimbursement",
			...
			"description": "Marks a reimbursement or reimbursive allowance so statutory bases can exclude it where appropriate.",
		},
		{
			"doctype": "Custom Field",
			"name": "Salary Component-za_variable_pay_treatment",
			"dt": "Salary Component",
			"module": "SA Payroll",
...
FIELDS_TO_DELETE_IF_EXIST = {
	"Employee": [
		...
		"custom_special_economic_zone",
		"custom_hours_per_month",
		"payroll_payable_bank_account",
		"custom_tax_number",
		"custom_residential_address",
	],
	"Company": [
		"custom_coida_registration_number",
		"custom_vat_number",
		"custom_sdl_reference_number",
		"custom_uif_reference_number",
		"custom_paye_reference_number",
	],
	"Payroll Settings": ["custom_coida_salary_component", "custom_disable_eti_calculation"],
