...
class VAT201Return(Document):
	...
	def submit_to_sars(self):
		"""Direct SARS submission is not supported in this release."""
		frappe.throw(
			"Direct SARS electronic submission is not supported in this release. "
			"Export your VAT201 working papers and complete filing manually through SARS eFiling."
		)
	...
	def get_vat_transactions(self):
		...
		for invoice in sales_invoices:
            ...
            """,
				{"parent": invoice.name, "account": vat_settings.output_vat_account},
				as_dict=1,
			)
	...
	def get_sales_invoices_exempt(self, from_date, to_date, vat_settings):
        ...
        """,
			{"from_date": from_date, "to_date": to_date, "account": vat_settings.output_vat_account},
			as_dict=1,
		)
