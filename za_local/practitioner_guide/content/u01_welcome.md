...
If you are the person **setting up** the localisation (chart of accounts, VAT settings, statutory rates, salary components), use the **[SA Practitioner Guide](/sa-guide/getting-started/overview)** instead. This guide assumes that setup is already done.
...
New to the system? Read [Finding Your Way: SA Workspaces](navigating-workspaces) next, then [Before You Begin](../first-time-configuration/before-you-begin).
